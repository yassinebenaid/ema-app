	...
	<section class="py-28">
		...
		>
			<div class="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
				<h1 class="text-sm text-indigo-600 font-medium">Over 200 successful deals</h1>
				<h2 class="text-4xl text-gray-800 font-extrabold md:text-5xl">
					We help startups to grow and make money
				</h2>
				<p>
					Sed ut perspiciatis unde omnis iste natus voluptatem accusantium doloremque laudantium, totam rem
		...
		<div class="mt-14 px-4 md:px-8">
			...
			<div class="flex justify-center items-center flex-wrap gap-x-12 gap-y-6 mt-6">
				<svg xmlns="http://www.w3.org/2000/svg" width="190" height="33" fill="none">
					...
					<defs>
						<clipPath id="a"><path fill="#fff" d="M0 0h190v32.454H0z" /></clipPath>
					</defs>
				</svg>
				<svg xmlns="http://www.w3.org/2000/svg" width="120" height="28" fill="none">
					...
					<defs>
						<clipPath id="a"><path fill="#fff" d="M0 .708h120v27.039H0z" /></clipPath>
					</defs>
				</svg>
				<svg xmlns="http://www.w3.org/2000/svg" width="180" height="27" fill="none">
					...
					<defs>
						<clipPath id="a"><path fill="#fff" d="M0 .133h180v26.189H0z" /></clipPath>
					</defs>
				</svg>
	...
	<section class="py-14">
		<div class="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
			<div class="max-w-xl space-y-3">
				...
				<p class="text-gray-800 text-3xl font-semibold sm:text-4xl">Everything you need to grow</p>
				<p>
